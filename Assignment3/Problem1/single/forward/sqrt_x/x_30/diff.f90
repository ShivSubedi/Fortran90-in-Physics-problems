...
!        forward
      write (kwrite,*) 'DERIVATIVE OF SQRT(X) VIA FORWARD DIFFERENTIATION METHOD FOR SINGLE PRECISION'
      write(kwrite,*) 'For x=30'
      write (kwrite,*) 'Taken analytical value: 1/(2*sqrt(1)) = 0.091287093 (Wolfram alpha)'
      write (kwrite,*)
      write (kwrite,*) '************************************************************************'
