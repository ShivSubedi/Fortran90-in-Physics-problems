...
! This program does the integration of the integral e^(-2x)/(x^2-sigma^2) from 0 to inf 
! via the GAuss-Legendre integration method      
	...
	parameter (pi=3.141592654d0)
        ...
        open(kwrite, file ='q3a.dat', status = 'unknown')
        write(kwrite,*)'#************************************************************************************'
